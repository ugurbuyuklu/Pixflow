...
interface Env {
  ...
  RESEARCH_WEB_ENABLED?: string
  RESEARCH_WEB_MODEL?: string
}
...
export class PixflowBackend extends Container<Env> {
  ...
  constructor(ctx: DurableObjectState, env: Env) {
    ...
    if (env.RESEARCH_WEB_ENABLED) vars.RESEARCH_WEB_ENABLED = env.RESEARCH_WEB_ENABLED
    if (env.RESEARCH_WEB_MODEL) vars.RESEARCH_WEB_MODEL = env.RESEARCH_WEB_MODEL
